# ============================================================================
# loadshape.py — Locust custom LoadTestShape for the benchmark.
#
# Implements the three-phase load profile the benchmark defines. ONE shape class, the active phase picked by env var LOAD_PHASE
# so each phase runs as a cleanly-bounded, reproducible Locust run; each phase runs as a
# cleanly-bounded, reproducible Locust run:
#
...
#
# Loaded by the app task file (tasks_otel_demo.py) so the demo gets a
# reproducible VU profile.
#
...
BASE_USERS = _int("BASE_USERS", 50)      # 50 VU per app,
